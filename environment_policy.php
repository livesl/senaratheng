...
<html>
    <head>
        ...
        <title>Senarath Group | Environment Policy</title>
        ...
        --><section  class="container">
            <div class="row section-min">
                <div class="col-md-offset-1 col-md-10  font6 historyTag ">
                    ...
                    <img ata-wow-delay=".3s" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.5s;" src="images/bg/about/env_policy.jpg" class="img-responsive" />
                    <br />
                    <h2 class="h-alt"><b></b></h2>

                    <div class="row">
                        <div class="col-sm-2"></div>
                        <div class="col-sm-8" style="text-align: justify; color: blue;">
                            <p> We conduct our business operations in an environmentally friendly manner by using our resources efficiently and 
                                managing our waste and emission to minimize the impact on the environment. By conducting regular meetings and 
                                through written communication we make sure our employees, Customers, suppliers and public are aware of our environmentally
                                friendly policy. We design and maintain systems that are subject to continuous improvement in order to meet our short 
                                and long term environment protection goals. We undertake to comply with government Legislations and expectations of the 
                                public in this regard. </p>
