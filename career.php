...
<html>
    <head>
        ...
        <title>Senarath Group | Career</title>
        ...
        --><section  class="container">
            <div class="row section-min">
                <div class="col-md-offset-1 col-md-10  font6 historyTag ">
                    ...
                    <img ata-wow-delay=".3s" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.5s;" src="images/bg/about/career.jpg" class="img-responsive" />
                    <br />
                    ...
                    <br /> 
                    <div class="col-lg-12">
                        <p>HR Manager<br> Maddumamulla Estate,<br>Thalammaehera,<br>Pannala,<br>Sri Lanka.</p>
