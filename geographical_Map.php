...
<html>
    <head>
        ...
        <title>Senarath Group | Geographical Map</title>
        ...
        --><section  class="container">
            <div class="row section-min">
                <div class="col-md-offset-1 col-md-10  font6 historyTag ">
                    ...
                    <img ata-wow-delay=".3s" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.5s;" src="images/bg/about/map.jpg" class="img-responsive" />
                    <br />
