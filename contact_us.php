...
<html>
    <head>
        ...
        <title>Senarath Group | Contact Us</title>
        ...
        --><section  class="container">
            <div class="row section-min">
                <div class="col-md-offset-1 col-md-10  font6 historyTag ">
                    ...
                    <img ata-wow-delay=".3s" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.5s;" src="images/bg/about/contact_us.jpg" class="img-responsive" />
                    <br />
                    ...
                    <div class="row">
                        <div div class="col-sm-6">
                            ...
                            <p style="font-size: large;">
                                Senarath Engineering (pvt) Ltd </br> Maddumamulla Estate</br>Thalammehera</br>Pannala    
