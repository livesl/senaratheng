(function ($) {
    ...
    Locations.prototype.html = function () {
        ...
        for (var i = 0; i < l; i++) {
            ...
            if (this.ar[i].main_heading != null && this.ar[i].main_heading != undefined) {
                html += "\t\t<h1>" + this.ar[i].main_heading + "</h1>\n"
            }
            if (this.ar[i].sub_heading != null && this.ar[i].sub_heading != undefined) {
                html += "\t\t<h2>" + this.ar[i].sub_heading + "</h2>\n"
            }
            ...
            if (this.ar[i].phone != null && this.ar[i].phone != undefined) {
                html += '\t\t<p class="phone">' + this.ar[i].phone + "</p>\n"
            }
            if (this.ar[i].content != null && this.ar[i].content != undefined) {
                html += '\t\t<p class="content">' + this.ar[i].content + "</p>\n"
            }
            html += "\t</div>\n";
            html += "</div>\n";
    ...
    Menu.prototype.init = function () {
        ...
        this.el.append("<ul style='display: inline; float:left' />");
