...
<html>
    <head>
        ...
        <title>Senarath Group | Management Team</title>
    ...
    <body id="page-top" data-spy="scroll" data-target=".navbar">
        ...
        --><section  class="container">
            <div class="row section-min">
                <div class="col-md-offset-1 col-md-10  font6 historyTag " style="text-align: left;">
                    <!--            <header class="bigHead">
                                    <h2 class="h-alt">About Us</h2>
                                </header>-->
                    <img ata-wow-delay=".3s" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.5s;" src="images/bg/about/management_team.jpg" class="img-responsive" />
                    <br />
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">Mr.K.H.M.Dinesh Kariyawasam  [B.Sc(Hons), Dip(HRM),Dip(PM), Dip(CMA)] </div>

                    </div>
                    <hr>
                    <div class="row" >
                        <div class="col-sm-4"> <img ata-wow-delay=".3s" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.5s;" src="images/bg/about/managementteamimage.jpg" class="img-responsive" /></div>
                        <div class="col-sm-4"> Mechanical Engineer </div>
                        <div class="col-sm-4">Mr.Nuwan Gunathilake [BEng(Hons) Mechanical, AMIMechE (UK)]</div>
                    ...
                    <div class="row" >
                        <div class="col-sm-4"> <img ata-wow-delay=".3s" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.5s;" src="images/bg/about/managementteamimage.jpg" class="img-responsive" /></div>
                        <div class="col-sm-4">  Mining Engineer  </div>
                        <div class="col-sm-4">Mr.Dilup Gunasinghe [B.Sc Eng(Hons)(Mining), P.G.Dip.(Mining)(Moratuwa)] </div>
                    ...
                    <div class="row" >
                        <div class="col-sm-4"> <img ata-wow-delay=".3s" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.5s;" src="images/bg/about/managementteamimage.jpg" class="img-responsive" /></div>
                        <div class="col-sm-4"> Chief Accountant  </div>
                        <div class="col-sm-4">Mr.Roshan Wickramasingh [B.B.Mgt (Finance)SP, CBA]</div>
                    ...
                    <div class="row" >
                        <div class="col-sm-4"> <img ata-wow-delay=".3s" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.5s;" src="images/bg/about/managementteamimage.jpg" class="img-responsive" /></div>
                        <div class="col-sm-4"> Sales & Marketing Manager</div>
                        <div class="col-sm-4">Mr.Anjana Herath[High.Dip (BM),Int.Dip.Computer Stud.(NCC)]</div>

                    </div>
                    <hr>
                    <div class="row" >
                        <div class="col-sm-4"> <img ata-wow-delay=".3s" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.5s;" src="images/bg/about/managementteamimage.jpg" class="img-responsive" /></div>
                        <div class="col-sm-4">Executive Coordinator</div>
                        <div class="col-sm-4">Mrs.Shyamalee Perera[NCT(QS)]</div>
                    ...
                    <div class="row" >
                        <div class="col-sm-4"> <img ata-wow-delay=".3s" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.5s;" src="images/bg/about/managementteamimage.jpg" class="img-responsive" /></div>
                        <div class="col-sm-4">Production Manager</div>
                        <div class="col-sm-4">Mr.J.A. Menaka Prasanna Jayasekara [NCT ( Civil)]</div>
                    ...
                    <div class="row" >
                        ...
                        <div class="col-sm-4">Mr.W.A. Darshana Madusanka [CBA]</div>
                    ...
                    <div class="row" >
                        <div class="col-sm-4"> <img ata-wow-delay=".3s" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.5s;" src="images/bg/about/managementteamimage.jpg" class="img-responsive" /></div>
                        <div class="col-sm-4"> Assistant Accountant</div>
                        <div class="col-sm-4"> Mr. M.N.S. Hemathilake [B.B.Mgt (ACC)SP, Dip (AAT) CBA]</div>
                    ...
                    <div class="row" >
                        <div class="col-sm-4"> <img ata-wow-delay=".3s" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.5s;" src="images/bg/about/managementteamimage.jpg" class="img-responsive" /></div>
                        <div class="col-sm-4">  Assistant Manager HR</div>
                        <div class="col-sm-4">  Ms.R.K. Chalani Wijayathunga [PQ (HRM)]</div>

                    </div>
                         <hr>
                    <div class="row" >
                        <div class="col-sm-4"> <img ata-wow-delay=".3s" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.5s;" src="images/bg/about/managementteamimage.jpg" class="img-responsive" /></div>
                        <div class="col-sm-4">Quantity Surveyor</div>
                        <div class="col-sm-4">Mr.B.M. Jeewan Priyadarshana [HND (QS)]</div>
                    ...
                    <div class="row" >
                        <div class="col-sm-4"> <img ata-wow-delay=".3s" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.5s;" src="images/bg/about/managementteamimage.jpg" class="img-responsive" /></div>
                        <div class="col-sm-4">Quantity Surveyor</div>
                        <div class="col-sm-4"> Mr.T.K. Ranil Buddika Sampath [ HND (QS & BE)]</div>

                    </div>
                            <hr>
                    <div class="row" >
                        <div class="col-sm-4"> <img ata-wow-delay=".3s" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.5s;" src="images/bg/about/managementteamimage.jpg" class="img-responsive" /></div>
                        <div class="col-sm-4">Draughtsman</div>
                        <div class="col-sm-4"> Mr.K.M. Nalin Sanjeewa Priyadarshana [NCT (Civil)]</div>
