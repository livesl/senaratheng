...
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
    ...
    <title>Senarath Group | CIDA - ICTAD</title>
...
<img ata-wow-delay=".3s" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.5s;" src="images/bg/about/chairman_massage.jpg" class="img-responsive" />
            ...
            Registration and grading is the most difficult challenge in competitive construction sector which measure the capacity of a company in 
            the construction sector. Grading is determined by evaluating mainly on company’s capacity of technical staff, strength of plant and 
            machinery and financial status of the company. Contractors are categorized under 10 grades which is known as C 1 to C 10. As per 
            the specifications of ICTAD, we have achieved following grades.  
              </p>
                   
              <ul>
                  <li>Highways and Road Construction  C3</li>
                  <li>Building Construction  C4</li>
                  <li>Bridge Construction  C7</li>
                  <li>Water Supply and Drainage  C7</li>
                  <li>Irrigation and land Drainage  C7</li>
