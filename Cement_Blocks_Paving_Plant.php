...
<html>
    <head>
        ...
        <title>Senarath Group | Cement Blocks & Paving Plant</title>
            ...
            <div class="row section-min">
                <div class="col-md-offset-1 col-md-10  font6 historyTag ">
                                <header class="bigHead">
                                    <h2 class="h-alt">Cement Blocks & Paving Plant</h2>
                                </header>
...
<!--                    <p style="text-align: justify;color: #007EFF;">
         ...
         <?php include './php/Cement_Blocks_Paving_Plant_gallery.php';?>
