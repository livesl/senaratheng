...
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
    ...
    <title>Senarath Group | ISO Certification</title>
...
<img ata-wow-delay=".3s" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.5s;" src="images/bg/about/iso.jpg" class="img-responsive" />
            <br />
            <h2 class="h-alt"><b></b></h2>
            <p style="text-align: justify;">
                
            We have developed our quality management system to meet the requirements of international standard of EN ISO 9001 : 2008 
            and has been Certified by TUV AUSTRIA GROUP.
 
              </p>
              <img ata-wow-delay=".3s" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.5s;" src="images/iso/image0.jpg" class="img-responsive" />
